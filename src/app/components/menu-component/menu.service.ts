...
export class MenuService {
    ...
    // getEmployees(): Observable<IEmployee[]> {   return this._http
    // .get('http://localhost:59637/api/employees')     .map((response: Response) =>
    ...
    getMenuByLocation(menuLocation: string): Observable < IEmployee > {
        return this
            ...
            .catch(this.handleError); } handleError(error: Response) {console.error(error);
